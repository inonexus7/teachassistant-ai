...
const Icebreaker: FC<ChatbotProps> = ({ clearAnswer, setAnswer }) => {
    ...
    return (<Grid item sm={12} md={5} lg={4} style={{ background: '#fff', padding: 30 }}>
        ...
        <Box sx={{ marginY: 2 }}>
            <TextField fullWidth label="Goals/Objectives (For example focus on team building, communication skills, or introducing a new topic)" variant='standard' name="goals/objectives" onChange={handleChange} />
        </Box>
        <Box sx={{ marginY: 2 }}>
            <TextField fullWidth label="Class Size" type="number" variant='standard' name="class_Size" onChange={handleChange} defaultValue={1} />
        </Box>
        <Box sx={{ marginY: 2 }}>
            <TextField fullWidth label="Duration" variant='standard' name="duration" onChange={handleChange} />
        </Box>
        <Box sx={{ marginY: 2 }}>
            <TextField fullWidth label="Total Number of Ideas(min 1-max 5)" variant='standard' type="number" name="num_Ideas" onChange={handleChange} defaultValue={1} />
        </Box>
        <Box sx={{ marginY: 2 }}>
            <TextField fullWidth label="Materials/Resources (Eg: They might have access to whiteboards, props, or technology)" variant='standard' name="materials/resources" onChange={handleChange} />
        </Box>
        <Box sx={{ marginY: 2 }}>
            <TextField fullWidth label="Preferred Style (icebreaker activity, such as games, discussions, role-playing, or creative exercises)" variant='standard' name="preferredStyle" onChange={handleChange} />
        </Box>
        <Box sx={{ marginY: 2 }}>
